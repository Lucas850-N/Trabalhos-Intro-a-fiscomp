...
!Declaração de variáveis
        ...
        call derivada_1_2_pontos_frente(x_0, f_linha_1, derivada_ln, desvio_derivada_1, h, dim_h, desvio_derivada_array_1)
        call derivada_1_2_pontos_tras(x_0, f_linha_2, derivada_ln, desvio_derivada_2, h, dim_h, desvio_derivada_array_2)
        call derivada_1_3_pontos_simetricos(x_0, f_linha_3, derivada_ln, desvio_derivada_3, h, dim_h, desvio_derivada_array_3)
        call derivada_1_5_pontos_simetricos(x_0, f_linha_4, derivada_ln, desvio_derivada_4, h, dim_h, desvio_derivada_array_4)
        call derivada_2_3_pontos_simetricos(x_0, f_linha_5, derivada_2_ln, desvio_derivada_5, h, dim_h, desvio_derivada_array_5)
        call derivada_2_5_pontos_simetricos(x_0, f_linha_6, derivada_2_ln, desvio_derivada_6, h, dim_h, desvio_derivada_array_6)
        call derivada_3_5_pontos_antisimetricos(x_0, f_linha_7, derivada_3_ln, desvio_derivada_7, h, dim_h, desvio_derivada_array_7)

        !Abre o arquivo tab1_out.dat e coloca os valores lá
        open(unit=2, file="tab1_out.dat", action="write")
        write(2, "(5X,A1, 5X, A50, 5X, A29, 5X, A29, 5X, A36, 5X, A36, 5X, A42)") "h", "derivada simétrica 3 pontos", &
          &"derivada para frente 2 pontos", "derivada para trás 2 pontos", "derivada segunda simétrica 3 pontos", &
        ...
        print *, "h = 0.000001"
        print *, "Justificativa: Esse valor de h apresentou maior precisão por ter o menor desvio, no valor de", desvio_derivada_array_3(12) 
        print *, ""
        print *, "Derivada para frente 2 pontos:"
        print *, "h = 0.00000001"
        print *, "Justificativa: Esse valor de h apresentou maior precisão por ter o menor desvio, no valor de", desvio_derivada_array_1(14)
        print *, ""
        print *, "Derivada para trás 2 pontos:"
        print *, "h = 0.00000001" 
        print *, "Justificativa: Esse valor de h apresentou maior precisão por ter o menor desvio, no valor de", desvio_derivada_array_2(14)
        print *, ""
        print *, "Derivada segunda simétrica 3 pontos"
        print *, "h = 0.0001"
        print *, "Justificativa: Esse valor de h apresentou maior precisão por ter o menor desvio, no valor de", desvio_derivada_array_5(9)
        print *, ""
        print *, "Derivada segunda simétrica 5 pontos"
        print *, "h = 0.001"
        print *, "Justificativa: Esse valor de h apresentou maior precisão por ter o menor desvio, no valor de", desvio_derivada_array_6(7)
        print *, ""
        print *, "Derivada terceira anti-simétrica 5 pontos"
        print *, "h = 0.0005"
        print *, "Justificativa: Esse valor de h apresentou maior precisão por ter o menor desvio, no valor de", desvio_derivada_array_7(8)
...
!Inicio dos subprogramas
        contains
                ...
                subroutine derivada_1_2_pontos_frente(x, f_linha, derivada_ln, desvio_derivada, h, dim_h, desvio_derivada_array)
                ...
                subroutine derivada_1_2_pontos_tras(x, f_linha, derivada_ln, desvio_derivada, h, dim_h, desvio_derivada_array)
                ...
                subroutine derivada_1_3_pontos_simetricos(x, f_linha, derivada_ln, desvio_derivada, h, dim_h, desvio_derivada_array)
                ...
                subroutine derivada_1_5_pontos_simetricos(x, f_linha, derivada_ln, desvio_derivada, h, dim_h, &
                    &desvio_derivada_array)
                ...
                subroutine derivada_2_3_pontos_simetricos(x, f_linha, derivada_2_ln, desvio_derivada, h, dim_h, &
                    &desvio_derivada_array)
                ...
                subroutine derivada_2_5_pontos_simetricos(x, f_linha, derivada_2_ln, desvio_derivada, h, dim_h, &
                    &desvio_derivada_array)
                ...
                subroutine derivada_3_5_pontos_antisimetricos(x, f_linha, derivada_3_ln, desvio_derivada, h, dim_h, &
                    &desvio_derivada_array)
